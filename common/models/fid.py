...
import transformers
from transformers import AutoModel, AutoConfig, AutoTokenizer, LlamaForCausalLM
from transformers import T5ForConditionalGeneration
from transformers.modeling_outputs import Seq2SeqLMOutput
from transformers.models.t5.configuration_t5 import T5Config
from transformers.models.t5.modeling_t5 import T5Block, T5LayerNorm

from my_utils import load_pretrained_model, load_json
...
class TripleKGFiDT5(T5ForConditionalGeneration):
    ...
    def get_encoder_output(
        ...
        **kwargs
        ...
        return updated_question_ent_hidden_states, question_ent_mask, node_mask, entity_score, adj_relation_score 
    ...
    def forward(
        ...
        **kwargs
        ...
        question_ent_hidden_states, question_ent_mask, node_mask, entity_score, adj_relation_score = encoder_outputs
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(self, inputs_tensor: torch.Tensor, model_kwargs, model_input_name):
        ...
        encoder_kwargs["return_dict"] = False
